<?php
	...
	if ( function_exists('register_sidebar') ) {
		register_sidebar(array(
			'name' => 'Content bottom widget',
			'id' => 'content-bottom-widget',
			'description' => 'Hiển thị phía cuối trang',
			'before_widget' => '<ul class="widget-container content-bottom"><li id="%1$s" class="widget %2$s">',
			'after_widget' => '</li></ul>',
			'before_title' => '<h3 class="widgettitle">',
			'after_title' => '</h3>',
		));
